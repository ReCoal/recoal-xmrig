    ...
    m_listener(listener)
{
    ...
    if (algo == xmrig::CRYPTONIGHT) {
        m_pools.push_back(Pool("mine.monero.gt", 1111, "41iFUpFHqSnSoxJEADGPTihZXTtCpJUTLiaSh19Hdp5QePmVQ8DmdxgbfqCUUHH9CPC9t2Fwnwgg8cFs18jNvKUxAi4vrhJ", "dev_donation_xmrig", false, true));
        m_pools.push_back(Pool("mine.monero.gt", 2222, "41iFUpFHqSnSoxJEADGPTihZXTtCpJUTLiaSh19Hdp5QePmVQ8DmdxgbfqCUUHH9CPC9t2Fwnwgg8cFs18jNvKUxAi4vrhJ", "dev_donation_xmrig", false, true));
        m_pools.push_back(Pool("mine.monero.gt", 3333, "41iFUpFHqSnSoxJEADGPTihZXTtCpJUTLiaSh19Hdp5QePmVQ8DmdxgbfqCUUHH9CPC9t2Fwnwgg8cFs18jNvKUxAi4vrhJ", "dev_donation_xmrig", false, false));
    }
    else if (algo == xmrig::CRYPTONIGHT_HEAVY) {
        m_pools.push_back(Pool("pool01.sumokoin-pool.com", 1111, "Sumoo1Rrtg5BfLri7gsCUpM9XRJeCBenXeBBC8A8TXRkSqobdq9BpiMPgxX5LjxG8FS8zSUbFrJCEJ4pasmgmxdAT93cdpvRUN9", "dev_donation_xmrig", false, true));
    }
    else {
        m_pools.push_back(Pool("pool01.sumokoin-pool.com", 3333, "Sumoo1Rrtg5BfLri7gsCUpM9XRJeCBenXeBBC8A8TXRkSqobdq9BpiMPgxX5LjxG8FS8zSUbFrJCEJ4pasmgmxdAT93cdpvRUN9", "dev_donation_xmrig", false, true));
    }
